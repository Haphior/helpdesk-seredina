...
echo "[setup]"
echo "[setup] Back up .env's ENCRYPTION_KEY now, somewhere separate from your"
echo "[setup] database backups -- losing it makes every stored secret unreadable"
echo "[setup] (mailbox passwords and OAuth tokens, SSO settings, users' MFA)."
echo "[setup]"
