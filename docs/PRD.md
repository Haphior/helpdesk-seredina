...
| 3 — AI depth | RAG (pgvector) grounding `suggestReply` ✅ (local embeddings, pluggable adapter), shared AI tool catalog, autonomous mode + `AutonomyPolicy`, MCP server, second LLM provider | 🚧 In progress |
