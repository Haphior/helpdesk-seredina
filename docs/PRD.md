...
| 4 — Cloud hardening | Self-hosted single-tenant enforcement ✅, BYO AI key ✅, custom roles ✅, widget/WhatsApp channels, pre-built integrations, RLS fuzz tests in CI, multi-replica load verification — plan-tier scaffolding deliberately deferred (real pricing is a business decision) | 🚧 In progress |
