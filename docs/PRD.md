...
| 4 — Cloud hardening | Self-hosted single-tenant enforcement ✅, BYO AI key ✅, custom roles ✅, first CI pipeline + RLS fuzz tests ✅, widget/WhatsApp channels, pre-built integrations, multi-replica load verification — plan-tier scaffolding deliberately deferred (real pricing is a business decision) | 🚧 In progress |
