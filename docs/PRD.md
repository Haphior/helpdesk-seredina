...
| 2 — Configurability & SLA | Alert ingestion (NOC/SOC) ✅, custom fields ✅, hardware/equipment catalog ✅, IT processes/procedures ✅, outbound webhooks ✅, macros ✅, SLA engine ✅, reporting v1 + dashboard ✅, Change Enablement ✅; Service Catalog, Release Management, Problem Management, Service Configuration Management — not yet started (see ROADMAP.md for the full expanded list; integrations, not a plugin platform, is the decided extensibility path) | 🚧 In progress |
